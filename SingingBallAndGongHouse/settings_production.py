...
# - ADMIN_EMAIL=singingbowlandgonghouse@gmail.com (optional, defaults to singingbowlandgonghouse@gmail.com)
...
EMAIL_HOST_USER = os.getenv("EMAIL_HOST_USER", "singingbowlandgonghouse@gmail.com")
