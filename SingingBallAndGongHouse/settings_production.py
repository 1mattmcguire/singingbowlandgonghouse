...
# 4) Set EMAIL_HOST_PASSWORD to that app password (not your Gmail login password).
...
if not EMAIL_HOST_USER or not EMAIL_HOST_PASSWORD:
    raise ImproperlyConfigured("EMAIL_HOST_USER and EMAIL_HOST_PASSWORD are required.")
